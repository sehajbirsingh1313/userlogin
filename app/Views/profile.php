        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
                ...
                <div style="float: center">
                    <img src="public/uploads/user/<?=session()->get('LoggedUserData')['profile_img']?>" alt="Profile Image" width="40%" style="margin-left: 90px;">
                    ...
                    <h4>Contact: <?=session()->get('LoggedUserData')['contact']?session()->get('LoggedUserData')['contact']:''?></h4><br>
                </div>
                <div class="row">
                    <div class="col-md-12" style="height: 50px;font-size: 25px;">
                        <a href="<?=base_url('/updateprofile')?>" class="btn btn-info">Update Profile</a>
                        <a href="<?=base_url('/deleteAccount')?>" class="btn btn-danger">Delete My Account</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12" style="height: 50px;font-size: 25px;">
